var Jcrop = function (e) {
    ...
    var i = function () {
        ...
        return r(e, [{
            ...
            key: "x1", set: function (e) {
                this.w = this.x2 - e, this.x = e
            }
        }, {
            key: "y1", set: function (e) {
            ...
            key: "aspect", get: function () {
                return this.w / this.h
            }
        }]), e
    }();
    i.fromPoints = function (e, t) {
        var n = [Math.min(e[0], t[0]), Math.min(e[1], t[1]), Math.max(e[0], t[0]), Math.max(e[1], t[1])], r = n[0],
            o = n[1], a = n[2], u = n[3];
        ...
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
            ...
            r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, o = new i;
        ...
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "br", o = new i;
    ...
    var a = function () {
        ...
        return i(e, [{
            ...
            key: "getDragQuadrant", value: function (e, t) {
                var n = this.locked[0] - e, r = this.locked[1] - t;
                return n < 0 && r < 0 ? "br" : n >= 0 && r >= 0 ? "tl" : n < 0 && r >= 0 ? "tr" : "bl"
            }
        }, {
            key: "getMaxRect", value: function (e, t, n) {
                return o.default.getMax(Math.abs(this.locked[0] - e), Math.abs(this.locked[1] - t), n)
            }
        }, {
            key: "translateStuckPoint", value: function (e, t) {
                var n = r(this.stuck, 3), i = n[0], a = n[1], u = n[2], s = null === i ? u : i + e,
                    c = null === a ? u : a + t;
                if (s > this.sw && (s = this.sw), c > this.sh && (c = this.sh), s < 0 && (s = 0), c < 0 && (c = 0), this.aspect) {
                    var f = this.getMaxRect(s, c, this.aspect), l = r(f, 2), h = l[0], d = l[1],
                        p = this.getDragQuadrant(s, c), v = o.default.fromPoint(this.locked, h, d, p);
                    return [v.x2, v.y2]
                }
                return [s, c]
            }
        }, {
            key: "getCornerPoint", value: function (e) {
                var t = this.rect;
                switch (e) {
                    case"n":
                        return [null, t.y, t.x];
            ...
            key: "getOppositeCorner", value: function (e) {
                switch (e) {
                    case"n":
                        return "se";
                    case"s":
    ...
    }(), i = f(n(0)), o = f(n(7)), a = f(n(11)), u = f(n(4)), s = f(n(9)), c = f(n(5));
    ...
    var l = function (e) {
        ...
        return function (e, t) {
            ...
            key: "limitWidgets", value: function () {
            ...
            key: "reorderWidgets", value: function () {
                var e = this, t = 10;
            ...
            key: "newWidget", value: function (e) {
            ...
            key: "updateShades", value: function () {
    ...
    var r = function () {
        ...
        }(), o = p(n(0)), a = p(n(8)), u = p(n(3)), s = p(n(4)), c = p(n(2)), f = p(n(5)), l = p(n(9)), h = p(n(13)),
        d = p(n(14));
    ...
    var v = function (e) {
        ...
        return function (e, t) {
            ...
            key: "initOptions", value: function () {
                ...
                this._optconf.aspectRatio = function (t) {
                    ...
                    if (e.aspect = t || null, e.aspect && n) {
                        var i = c.default.getMax(n.w, n.h, t), o = r(i, 2), a = o[0], u = o[1];
                        e.render(c.default.fromPoint([n.x, n.y], a, u))
                    }
                }
            }
        }, {
            key: "attachToStage", value: function (e) {
                this.stage = e, this.emit("crop.attach")
            }
        }, {
            key: "attachFocus", value: function () {
                var e = this;
            ...
            key: "animate", value: function (e, t, n) {
                var r = this, i = this;
            ...
            key: "createMover", value: function () {
                var e, t, n, r = this;
            ...
            key: "nudge", value: function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                    t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, n = this.el.parentElement,
                    r = [n.offsetWidth, n.offsetHeight], i = r[0], o = r[1];
                e && (this.pos.x += e), t && (this.pos.y += t), this.render(this.pos.rebound(i, o)), this.emit("crop.change")
            }
        }, {
            key: "createHandles", value: function () {
                var e = this;
                return this.options.handles.forEach(function (t) {
                    ...
                    r.appendTo(e.el), (0, s.default)(r.el, function () {
                        ...
                        var r = e.el.parentElement, i = r.offsetWidth, o = r.offsetHeight;
            ...
            key: "doneDragging", value: function () {
                this.pos = c.default.from(this.el)
            }
        }]), t
    }();
    v.create = function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = document.createElement("div"),
            n = (0, o.default)({}, u.default, e);
        return t.setAttribute("tabindex", "0"), t.className = n.cropperClass || "jcrop-widget", new (e.widgetConstructor || v)(t, n)
    }, t.default = v
}, function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0});
    ...
    "use strict";
    var r = e.exports = {
        def: "outQuad", swing: function (e, t, n, i) {
    ...
    var s = function () {
        ...
        return r(e, [{
            ...
            key: "adjust", value: function (e) {
                var t = i.default.from(this.el), n = this.shades;
    ...
    var c = function (e) {
        ...
        return function (e, t) {
            ...
            key: "w", set: function (e) {
                this.el.style.width = e + "px"
            }
        }, {
            key: "h", set: function (e) {
                this.el.style.height = e + "px"
            }
        }, {
            key: "x", set: function (e) {
                this.el.style.left = e + "px"
            }
        }]), t
    }();
    c.create = function (e, t) {
        var n = document.createElement("div"), r = e.shadeClass || "jcrop-shade";
        return n.className = r + " " + t, new c(n).color(e.shadeColor).opacity(e.shadeOpacity)
    }, c.Manager = s, t.default = c
}, function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.DomObj = t.Shade = t.load = t.easing = t.Sticker = t.Handle = t.Rect = t.Widget = t.Dragger = t.defaults = t.Stage = void 0, t.attach = b;
    var r = y(n(0)), i = y(n(3)), o = y(n(6)), a = y(n(15)), u = y(n(7)), s = y(n(11)), c = y(n(8)), f = y(n(4)),
        l = y(n(2)), h = y(n(5)), d = y(n(1)), p = y(n(10)), v = y(n(16));
    ...
    t.default = function (e, t, n, i) {
        var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 30,
            a = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : "swing", u = ["x", "y", "w", "h"],
            s = t.normalize();
    ...
    var o = function (e) {
        ...
        return function (e, t) {
            ...
            key: "resizeToImage", value: function () {
                var e = this.srcEl.width, t = this.srcEl.height;
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), r.check = function (e) {
