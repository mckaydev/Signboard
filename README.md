...
6. OCR한 데이터를 '네이버 Map API'에 전송하여 가게의 정보를 요청합니다.
7. 로그인한 사용자의 경우에는 데이터베이스에 검색기록을 저장합니다.
    1. 처음 검색하는 사용자라면 사용자 전용의 검색기록 테이블을 DB에 생성합니다.
    2. 상호명, 메뉴, 연락처를 테이블에 저장하고 북마크 여부 에는 0을 저장합니다.
8. API가 반환한 가게의 정보를 사용자에게 반환합니다.
